...
owner: `*${emoji.owner} Perintah owner*\n
    ${userTag} Perintah ini hanya dapat digunakan oleh *owner Bot*!`,
        moderator: `*${emoji.moderator} Perintah Moderator*\n
    ${userTag} Perintah ini hanya dapat digunakan oleh *Moderator*!`,
        premium: `*${emoji.premium} Perintah Premium*\n
    ${userTag} Perintah ini hanya untuk *Anggota Premium*!`,
        grup: `*${emoji.group} Perintah Grup*\n
    ${userTag} Perintah ini hanya dapat digunakan di *Obrolan Grup*!`,
        pribadi: `*${emoji.private} Perintah Pribadi*\n
    ${userTag} Perintah ini hanya dapat digunakan di *Obrolan Pribadi*!`,
        admin: `*${emoji.admin} Perintah Admin*\n
    ${userTag} Perintah ini hanya untuk *Admin Grup*!`,
        botAdmin: `*${emoji.botAdmin} Perintah Admin Bot*\n
    ${userTag} Jadikan bot sebagai *Admin* untuk menggunakan Perintah ini!`,
        unreg: `*${emoji.unreg} Permintaan Pendaftaran*\n
    ${userTag} Silakan mendaftar untuk menggunakan fitur ini dengan mengetik:\n\n*#register name.age*\n\nContoh: *#register ${m.name}.18*!`,
        nsfw: `*${emoji.nsfw} Perintah NSFW*\n
    ${userTag} NSFW tidak aktif. Silakan hubungi admin Grup untuk mengaktifkan fitur ini!`,
        batasi: `*${emoji.restrict} Fitur Tidak Aktif*\n
